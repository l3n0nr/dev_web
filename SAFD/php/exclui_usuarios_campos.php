        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <ol class="breadcrumb">
                        <li><a href=""><i class="fa fa-dashboard"></i> Inicio> Excluindo usuarios do sistema </a></li>
                    </ol>
                </section>
                                ...
                                <div class="box-body">
                                    <form action="teste.php" method="post">   
                                        <div class="form-group">
                                          ...
                                          value=" <?php echo $siape_funcionario; ?> " disabled="">

                                          <label>Setor</label>
                                          <input class="form-control" id="setor" placeholder="email" type="text" disabled="">
                                        ...
                                        <br>
                                        <a href="p_exclui_usuarios.php"> VOLTAR </a>
