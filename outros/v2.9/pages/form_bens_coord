...
<html>
  <head>
    ...
    <aside class="main-sidebar">
      ...
      <!-- =============================================== -->
      <!--FORMULARIO DE BENS-->
      <form onsubmit="alert('Solicitação enviada para avaliação!')">
        <div class="content-wrapper">
          ...
          <div class="form-group">
            ...
            <label>Assinatura: ________</label>
            <label>Data:_________</label>
          </div>
          ...
          <div class="box-footer">
            ...
            <button type="submit"
                    class="btn btn-warning pull-right">Enviar para a próxima etapa</button>
          </div>
        </div>
      </form>
